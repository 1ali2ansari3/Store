...
<head>
  ...
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
  <!-- CSS Files -->
  <link id="pagestyle" href=" {{ url('admin/css/material-dashboard.css?v=3.0.4') }}" rel="stylesheet" />
  <link id="pagestyle" href=" {{ url('admin/css/style.css') }} "  rel="stylesheet" />
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=# target="_blank">
        ...
        <a class="nav-brand" href="{{url('/')}}"><img style="height:250px; width:250px; margin-top:-50%" src="{{ url('img/FAOO.png') }}" alt=""></a>
    </a>
    </div>
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a class="btn bg-gradient-primary mt-4 w-100" href="/" type="button">Go To Home</a>
      </div>
    </div>
  </aside>
